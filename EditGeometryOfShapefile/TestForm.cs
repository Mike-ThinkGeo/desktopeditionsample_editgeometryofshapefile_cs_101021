...
namespace  EditGeometryOfShapefile
{
    public partial class TestForm : Form
    {
        ...
        private void TestForm_Load(object sender, EventArgs e)
        {
            ...
            ShapeFileFeatureLayer layer1 = new ShapeFileFeatureLayer(@"../../data/austinstreets.shp",ShapeFileReadWriteMode.ReadWrite);
            layer1.ZoomLevelSet.ZoomLevel01.DefaultLineStyle = LineStyles.LocalRoad1;
